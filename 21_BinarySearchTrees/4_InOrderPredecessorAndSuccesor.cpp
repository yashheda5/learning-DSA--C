...
int main() {
    ...
    levelOrder(root);
    cout<<"Enter the element whose inorder predecessor u want to find ";
    int p;
    cin>>p;
    Node* temp=findNode(root ,p);
    cout<<"predecessor is = "<<minValue(temp)<<endl;
    Node* temp2=findNode(root ,p);
    cout<<"succesor is = "<<maxValue(temp2)<<endl;
    return 0;
}
